...
class CSVOutputProcessor(object):
    ...
    def __init__(self, output_pipe, delimiter=b',', encoding=b'utf-8', cols=None):
...
class CSVInputProcessor(object):
    ...
    def __init__(self, input_pipe, encoding=b'utf-8', delimiter=b',', cols=None):
...
class CSVFormat(Format):
    ...
    def __init__(self, delimiter=b',', encoding=b'utf-8', cols=None):
